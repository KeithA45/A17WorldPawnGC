...
namespace A17FilePawnGC
{
	...
	internal static class Detours
	{
		...
		public static List<DetourPair> GetDetours(Assembly assembly)
		{
			...
			{
				// Get the raw methods
				GetTimedDetouredMethods(ref detours, toType);
				// Get the cloaked methods (properties)
				GetTimedDetouredProperties(ref detours, toType);
			}
		...
		/// <param name="sequence">Injection sequence</param>
		/// <param name="timing">Injection timing</param>
		private static void GetTimedDetouredMethods(ref List<DetourPair> detours, Type destinationType)
		{
		...
		/// <param name="sequence">Injection sequence</param>
		/// <param name="timing">Injection timing</param>
		private static void GetTimedDetouredProperties(ref List<DetourPair> detours, Type destinationType)
		{
